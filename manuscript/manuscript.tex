...
and reduces incorrect template roundtrips by 90\% compared to the
original rdchiral and 94\% compared to rdchiral\_cpp.
...
$\to$ template $\to$ MCS $\to$ neural.  Each mapper operates on
...
\begin{table}[htbp]
  ...
  \begin{tabular}{lcc}
    ...
    + Template mapper              & \textit{TBD}               & \textit{TBD}                       \\
    + MCS mapper                   & $\sim$60                   & $\sim$90                           \\
    \bottomrule
  \end{tabular}
\end{table}
...
\begin{table}[htbp]
  ...
  \begin{tabular}{lcc}
    ...
    \midrule
    rdchiral         & \textit{TBD}                       & $-$90\%                                \\
    rdchiral\_cpp    & \textit{TBD}                       & $-$94\%                                \\
