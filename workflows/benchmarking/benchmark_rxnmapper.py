"""Standalone benchmark script for rxnmapper.

Run inside a venv that has rxnmapper[rdkit] installed.
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Benchmark rxnmapper on gold reactions"
    )
    ...
    print(f"Benchmarking rxnmapper on {len(gold_reactions)} reactions...")
